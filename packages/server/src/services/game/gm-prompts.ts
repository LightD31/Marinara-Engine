...
export function buildGmFormatReminder(
  ...
  lines.push(
    ...
    `- Treat only quoted player text as spoken aloud; unquoted text is action, narration, or internal thought that NPCs cannot perceive unless made observable. Never quote or speak for the player character: you may narrate obvious, low-stakes participation indirectly in second person (nodding during conversation, laying out details, looking around, etc.), but never invent strategic choices or exact dialogue. Example:`,
